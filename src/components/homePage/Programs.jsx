        ...
        <div className="container">
          ...
          <div className="program-container flex gap-5">
            <div className="program1 p-5 rounded-2xl">
              <img src="src\assests\programs\dumbbells.png" className="w-[90px] rotate-[-15deg] mb-5" alt="dumbbells-img" />
              ...
              <p className="text-[15px] flex items-center gap-4">
                ...
                <img
                  style={{ height: "12px" }}
                  src="src\assests\programs\arrow.png"
                  alt="arrow logo"
                />
              </p>
            </div>
            <div className="program2 p-5 rounded-2xl">
              <img src="src\assests\programs\yoga.png" className="w-[74px] mb-5" alt="yoga-img" />
            ...
            <div className="program3 p-5 rounded-2xl">
              <img src="src\assests\programs\bicep.png" className="w-[74px] mb-5" alt="bicep-img" />
              ...
              <p className="text-[15px] flex items-center gap-4">
                ...
                <img
                  style={{ height: "12px" }}
                  src="src\assests\programs\arrow1.png"
                  alt="arrow logo"
                />
              </p>
            </div>
            <div className="program4 p-5 rounded-2xl">
              <img src="src\assests\programs\run.png" className="w-[56px] mb-5" alt="run-img" />
